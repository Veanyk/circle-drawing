...
app.post('/debug/write-log', (req, res) => {
  log('[debug] manual log write', req.body || {});
  res.json({ ok: true, wrote: true, path: LOG_PATH });
});
...
// Mini App эндпоинт для закрепления реферала с верификацией initData
